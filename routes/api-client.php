...
Route::group([
    ...
    Route::middleware([ResourceLimit::Command->middleware()])
        ->post('/command', [Client\Servers\CommandController::class, 'index']);
    Route::middleware([ResourceLimit::Power->middleware()])
        ->post('/power', [Client\Servers\PowerController::class, 'index']);
    ...
    Route::group(['prefix' => '/files'], function () {
        ...
        Route::middleware([ResourceLimit::FileMutation->middleware()])->group(function () {
