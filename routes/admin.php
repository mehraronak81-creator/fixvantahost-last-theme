...
/*
|--------------------------------------------------------------------------
| Backup Recovery Centre Routes
|--------------------------------------------------------------------------
*/
Route::get('/recovery', [Admin\RecoveryController::class, 'index'])->name('admin.recovery.index');
Route::post('/recovery/{backup:uuid}/restore', [Admin\RecoveryController::class, 'restore'])->name('admin.recovery.restore');
