...
<html data-theme="dark">
    <head>
        ...
        <link rel="mask-icon" href="/favicons/safari-pinned-tab.svg" color="#4F7CFF">
        ...
        @section('scripts')
            ...
            {{-- VantaHost admin styling is centralized in the locked stylesheet below. --}}
