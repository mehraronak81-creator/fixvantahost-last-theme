    ...
    <div class="col-xs-12">
        ...
        ">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-info-circle" style="margin-right:8px;color:var(--vh-accent,#4f8cff);"></i>System Information</h3>
            </div>
            <div class="box-body">
                @if ($version->isLatestPanel())
...
<div class="row" id="system-health">
    <div class="col-lg-3 col-xs-6">
        <div class="small-box" style="background:linear-gradient(135deg,#4f8cff,#23c4e8);border-radius:12px;">
            <div class="inner">
...
<div class="row">
    <div class="col-md-6">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-microchip" style="margin-right:8px;color:var(--vh-accent,#4f8cff);"></i>Memory Allocation</h3>
            ...
            <div class="box-body">
                <div style="background:var(--vh-surface,#12121a);border-radius:8px;overflow:hidden;height:28px;margin-bottom:10px;">
                    <div id="mem-bar" style="height:100%;background:linear-gradient(90deg,#4f8cff,#23c4e8);border-radius:8px;transition:width 0.6s ease;width:{{ $totalMemory > 0 ? round(($allocatedMemory / $totalMemory) * 100, 1) : 0 }}%;display:flex;align-items:center;justify-content:center;color:#fff;font-size:12px;font-weight:600;">
    ...
    <div class="col-md-6">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-hdd-o" style="margin-right:8px;color:var(--vh-accent,#4f8cff);"></i>Disk Allocation</h3>
...
<div class="row">
    <div class="col-xs-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-heartbeat" style="margin-right:8px;color:var(--vh-accent,#4f8cff);"></i>Node Health Status</h3>
                            ...
                            <div style="background:var(--vh-surface,#12121a);border:1px solid var(--vh-border,#2a2a3a);border-radius:10px;padding:15px;position:relative;" id="node-card-{{ $node['id'] }}">
                                ...
                                <div style="margin-bottom:6px;">
                                    ...
                                    <div style="background:var(--vh-surface-2,#1a1a28);border-radius:4px;overflow:hidden;height:6px;">
                                        <div style="height:100%;border-radius:4px;transition:width 0.6s ease;width:{{ $node['memory_percent'] }}%;background:{{ $node['memory_percent'] > 90 ? '#ff4757' : ($node['memory_percent'] > 70 ? '#ffa502' : '#4f8cff') }};"></div>
                                    </div>
                                </div>
                                {{-- Disk bar --}}
                                <div>
...
<div class="row" id="quick-actions">
    <div class="col-xs-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-bolt" style="margin-right:8px;color:var(--vh-accent,#4f8cff);"></i>Quick Actions</h3>
            </div>
            <div class="box-body">
                <div class="row">
...
<div class="row">
    <div class="col-xs-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-history" style="margin-right:8px;color:var(--vh-accent,#4f8cff);"></i>Recent Activity</h3>
                <div class="box-tools pull-right">
