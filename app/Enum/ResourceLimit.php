 ...
 * applies to selected creation and high-impact mutation flows, not routine reads.
 */
enum ResourceLimit
{
    case Allocation;
    ...
    public function limit(): Limit
    {
        return match($this) {
            ...
            self::Command => Limit::perMinute((int) config('vantahost.abuse.command_per_minute', 30)),
            self::Power => Limit::perMinute((int) config('vantahost.abuse.power_per_minute', 10)),
            self::FileMutation => Limit::perMinute((int) config('vantahost.abuse.file_mutations_per_minute', 60)),
